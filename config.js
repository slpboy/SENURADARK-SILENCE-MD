...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~qMADWSRT#lREvsOr3y_YJmrK-E0pWwwYJ2iIAN6peVyzRbf0_KQQ",
    CAPTION: process.env.CAPTION || "POWERED BY 🫟SHENU🫟",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE I'M SHENU-MD WHATSAPP BOT 😊♻️",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "94784504579",
    OWNER_NAME: process.env.OWNER_NAME || "➺ѕเℓεɳƭ_ℓσѵε૨࿐",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "➺DARK-SHENU-MD",
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя 🫩sтαтυs sεεη נυsт ησω🫟`",
